...
//     <div
//       ref={containerRef}
//       className="flex flex-col py-12  items-center justify-center bg-gradient-to-b from-[#1a3c8b] via-[#000000] to-black text-white text-center px-4 sm:px-6 md:px-8"
//     >
//       {/* Top Text */}
...
const Video = () => {
  ...
  return (
    ...
    >
      {/* Top Text */}
      <p className="text-[10px] sm:text-xs md:text-sm py-2 sm:py-4 tracking-wide uppercase mb-2 sm:mb-3 opacity-80">
        Join thousands on MavenAdvert™
      </p>
      ...
      <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 relative w-full max-w-full sm:max-w-4xl px-2 sm:px-0">
        <div className="relative w-full h-[200px] sm:h-[250px] md:h-[350px] lg:h-[450px] xl:h-[500px] rounded-2xl overflow-hidden shadow-2xl bg-black">
          <iframe
            ref={videoRef}
            className="absolute top-0 left-0 w-full h-full"
            src="https://www.youtube.com/embed/dQw4w9WgXcQ?controls=1&mute=0&loop=1&playlist=dQw4w9WgXcQ"

...
function PersonalBrand() {
  ...
  return (
    <section className="w-full min-h-screen flex flex-col justify-center items-center bg-white px-4 ">
      {/* Heading */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-6xl">
        {features.map((feature, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center p-6 border border-neutral-200 rounded-xl hover:shadow-lg transition-shadow"
          >

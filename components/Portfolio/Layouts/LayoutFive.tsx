  ...
  return (
    <div className="w-full flex flex-col gap-10 pb-20">
      <section
        ...
        style={{
          backgroundImage: `url(${images?.[0] || "/layout5/hero.jpg"})`,
        }}
      />
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20">
        <img src={images?.[1] || "/layout5/item1.jpg"} className="rounded-xl"  alt="Maven Advert Image"/>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20">
        <img src={images?.[2] || "/layout5/item2.jpg"} className="rounded-xl"  alt="Maven Advert Image"/>
        <img src={images?.[3] || "/layout5/item3.jpg"} className="rounded-xl"  alt="Maven Advert Image"/>
      </section>
      <section className="w-full px-6 md:px-20">
        <img
          src={images?.[4] || "/layout5/item4.jpg"}

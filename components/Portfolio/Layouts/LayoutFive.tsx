  ...
  return (
    <div className="w-full flex flex-col gap-10 pb-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20">
        <img src={images?.[1] || "/layout5/item1.jpg"} className="rounded-xl" />
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20">
        <img src={images?.[2] || "/layout5/item2.jpg"} className="rounded-xl" />
        <img src={images?.[3] || "/layout5/item3.jpg"} className="rounded-xl" />
      </section>
